...
class _BarMenuState extends State<BarMenu> {
  ...
  // Función asíncrona para cargar los datos del bar desde Firestore
  Future<void> loadBarData() async {
    ...
    // Si existen tapas en los datos obtenidos
    if (!(datos['tapas']?.isEmpty ?? true)) {
      setState(() {
    ...
    // Si existen bebidas en los datos obtenidos
    if (!(datos['bebidas']?.isEmpty ?? true)) {
      setState(() {
    ...
    // Si existen postres en los datos obtenidos
    if (!(datos['postres']?.isEmpty ?? true)) {
      setState(() {
      ...
      children: [
        ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            // Devuelve un Card con información detallada del elemento
            return Card(
              child: Row(
                ...
                children: [
                  FutureBuilder(
                    ...
                    builder: (BuildContext context, AsyncSnapshot<String> snapshot) {
                      // Si se ha obtenido la URL de descarga de la imagen, muestra la imagen en un contenedor
                      if (snapshot.hasData) {
                        return Container(
                          height: 225,
                          width: 175,
                        ...
                        // De lo contrario, muestra un indicador de progreso
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Muestra el nombre y precio del elemento
                          Text(
                          ...
                          const SizedBox(height: 8),
                          // Añade un botón para añadir el elemento al carrito
                          ElevatedButton(
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Si estamos esperando a que se carguen los datos, mostramos un indicador de carga.
          if (snapshot.connectionState == ConnectionState.waiting) {
            return const Center(child: CircularProgressIndicator());
          }

          // Si no hay datos o no existen, mostramos un mensaje de error.
